...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'stellauinsu@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Sistem penelitian Pengabdian Publikasi ilmiah'; // Isikan dengan nama pengirim
    protected $password = 'gwbauqjllvznefxn'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->AddEmbeddedImage('images/logo/logo.png', 'logo', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
